      ...
      <section id="services" className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <a href="#contact" className="text-gray border border-gray-900 px-6 py-3 rounded-lg hover:bg-goldenrod hover:text-white hover:border-gray-500">Ask for a Demo</a>
          </div>
        </div>
      </section>
    );
